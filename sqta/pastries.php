...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
      <a class="navbar-brand" href="index.html">MB</a>
  ...
  <div class="row" style="padding-top: 50px;">
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-md-4">
          <img src="images/pastries/pastries.jpg" class="card-img" alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
    ...
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row no-gutters">
        <div class="col-md-4">
          <img src="images/pastries/pastries2.jpg" class="card-img" alt="cake" style="height: 100%">
        </div>
        <div class="col-md-8">
          <div class="card-body">
